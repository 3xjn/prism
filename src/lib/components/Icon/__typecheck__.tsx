...
const validIconProps: IconProps[] = [
	{ name: "search" },
	{ name: "settings", size: "sm", color: "text.secondary" },
	...
	{ name: "alert-circle", bg: "background.surface", bgTransparency: 0, clip: true },
...
type InvalidIconColorAllowed = "primary" extends NonNullable<IconProps["color"]> ? true : false;
