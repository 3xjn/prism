		...
		<StoryCanvas>
			<Box width="100%" bg="background.surface" radius="md" p="lg">
				<Stack width="100%" gap="md">
					<Text text="Backdrop" size="lg" weight={700} color="text.primary" />
					<Text
					...
					<Box width="100%" height={220} bg={theme.colors.action.hover} radius="md" p="lg" clip>
						<Stack width="100%" gap="sm">
							<Text text="Preview area" weight={600} color="text.primary" />
							<Text text={shown ? "Backdrop is visible. Click the dim layer to dismiss it." : "Backdrop dismissed."} color="text.secondary" wrap width="100%" />
